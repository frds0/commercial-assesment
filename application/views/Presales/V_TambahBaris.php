    ...
    <div class="row" id="barisdetaill<?= $baris ?>">
        <div class="col-sm-6">
            <div class="form-group-material">
                ...
                <select id="id_arh<?= $baris ?>" name="nama_arh[]" onchange="cek_arh1()" class="form-control select2bs4" required>
        ...
        <div class="col-sm-4">
            <div class="form-group-material mb-3">
                ...
                <input type="text" name="sub_lokasi_arh[]" id="sub_lokasi_arh<?= $baris ?>" class="form-control form-control-sm">
            </div>
        </div>
