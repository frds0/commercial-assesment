                                    ...
                                    <td style="vertical-align: middle;">
                                        <div class="row mb-2">
                                            <div class="col-sm-12 text-center">
                                                <a class="btn btn-info btn-sm text-center" title="Lihat Assesment" href="<?php echo site_url('Presales/CTR_Presales/Penilaian/') . $row->id_permintaan ?>">
    ...
    <div class="modal fade" id="approveModal<?php echo $row->id_permintaan ?>" tabindex="-1" aria-labelledby="approveModalLabel<?php echo $row->id_permintaan ?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo site_url('Presales/CTR_Presales/approve/' . $id_permintaan) ?>" method="POST">
    ...
    <div class="modal fade" id="revisiModal<?php echo $row->id_permintaan ?>" tabindex="-1" aria-labelledby="revisiModalLabel<?php echo $row->id_permintaan ?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo site_url('Presales/CTR_Presales/revisii/' . $id_permintaan) ?>" method="POST">
                    <div class="modal-body">
                        <span>
