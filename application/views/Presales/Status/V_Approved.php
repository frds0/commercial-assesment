            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item">Assesment Disetujui</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                ...
                                foreach ($isi as $row) { ?>
                                    <tr>
                                        ...
                                        <td style="width: 150px; vertical-align:middle ;" class="">
                                            <?php echo $row->status ?> <i class="fas fa-check text-success"></i></td>
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="<?php echo site_url('CTR_Laporan/index/' . $row->id_permintaan) ?>" method="POST">
                                    ...
                                    <div class="col-sm-12 text-center mb-3">
                                        ...
                                        <button type="submit" class="btn bg-teal btn-sm"><i class="fas fa-check-square" target="_blank"></i> Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
