<!-- Tambah Data Wawancara -->
<div class="modal fade" data-backdrop="static" id="wawancaraModal" tabindex="-1" aria-labelledby="wawancaraModalLabel" aria-hidden="true">
            ...
            <div class="modal-body modal-xl">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('Presales/CTR_Presales/PilihPertanyaanWawancara') ?>" enctype="multipart/form-data" method="POST">
                            <div class="card-body" style="overflow: auto;">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group-material mt-2">
                                            <label style="font-weight: normal">Diwawancarai Oleh </label>
                                            <input type="text" name="diwawancarai" class="form-control form-control-sm" value="<?php echo $this->session->userdata('nama') ?>" readonly required maxlength="125">
                                        </div>
                                        <div class="form-group-material mt-2">
                                            <label style="font-weight: normal">Jabatan</label>
                                            <input type="text" name="jabatan1" value="Operational" readonly class="form-control form-control-sm required">
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group-material mt-2">
                                            <label style="font-weight: normal">Yang Diwawancara</label>
                                            <input type="text" name="diwawancara" class="form-control form-control-sm" required maxlength="125">
                                        </div>
                                        <div class="form-group-material mt-2">
                                            <label style="font-weight: normal">Jabatan</label>
                                            <input type="text" name="jabatan2" class="form-control form-control-sm" required maxlength="125">
                                        </div>
                                    </div>
                                </div>
                                <div class="line">
                                    ...
                                    foreach ($pertanyaan as $row) { ?>
                                        ...
                                        <?php if ($row->is_active == 'Aktif') { ?>
                                            <tr>
                                                ...
                                                <td style=" vertical-align: middle;"><?php echo $row->pertanyaan ?>
                                                </td>
                                                <td style=" vertical-align: middle;"> <?php echo $row->proses ?></td>
                                                <td style=" vertical-align: middle;">
                                                    <input type="checkbox" class="form-control form-control-sm box1" name="id_pertanyaan_wawancara[]" value="<?php echo $row->id_pertanyaan_wawancara ?>">&nbsp;&nbsp;&nbsp;&nbsp;
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php } ?>
                ...
                <div class="modal-body modal-xl">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('Presales/CTR_Presales/UpdateWawancara') ?>" enctype="multipart/form-data" method="POST">
                                <div class="card-body">
                                    <div class="row">
                                    </div>
                                    <div class="row">
...
<!-- Print Excel Wawancara -->
<?php $no = 1;
foreach ($nama as $row) { ?>
    <div class="modal fade" data-backdrop="static" id="printExcelWawancaraModal<?php echo $row->id_wawancara ?>" tabindex="-1" aria-labelledby="printExcelWawancaraModalLabel<?php echo $row->id_wawancara ?>" aria-hidden="true">
            ...
            <div class=" modal-content">
                ...
                <div class="modal-body modal-xl">
                    <div class=" card">
                        ...
                        <form class="form-horizontal" action="<?php echo site_url('CTR_Laporan/PrintExcelWawancara/' . $row->id_permintaan) ?>" method="POST">
                            <div class="card-body">
                                <input type="hidden" name="id_wawancara" value="<?php echo $row->id_wawancara ?>" id="">
                                <div class="text-center mb-4">
                                    <h3>Print Wawancara ?</h3>
...
<script type="text/javascript">
    // upload Gambar
    var uploadFieldWawancara = document.getElementById("file_wawancara");
    var txt = '';
    var ekstensiOk = /(\.jpg|\.jpeg|\.png|\.gif)$/i;
    uploadFieldWawancara.onchange = function() {
        if (this.files[0].size > 500000) { // ini untuk ukuran 800KB, 500000 untuk 500KB.
            ...
            txt = '<i class="fas fa-exclamation-triangle"></i> <i>Formmat Gambar Harus Berupa .JPG/.JPEG/.PNG</i>';
            this.value = "";
        };
