<!-- Add Data SSA2 -->
<div class="modal fade" data-backdrop="static" id="ssa2Modal" tabindex="-1" aria-labelledby="ssa2ModalLabel" aria-hidden="true">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    <form method="post">
                                        <div class="form-group">
                                            <label class="form-control-label">Jumlah POS :</label>
                            ...
                            <?php if ($this->input->post('jumlah_pos')) { ?>
                                <form class="form-horizontal" action="<?php echo site_url('Presales/CTR_Presales/SimpanSSA2') ?>" enctype="multipart/form-data" method="POST">
                                    <?php $no = 1;
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group-material mt-2">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="file" accept="image/png, image/jpg, image/jpeg" name="foto_ssa2[]" id="file_ssa2" class="form-control p-1 file_ssa2">
                                                                <p id="message_ssa2" class="float-right text-danger message_ssa2" style="font-size: 12px;"></p>
                                                            </div>
                                                            <div class="form-group">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea cols="30" rows="7" id="kerawanan" class="form-control" name="kerawanan[]" onkeyup="HitungKerawanan()" maxlength="225" required></textarea>
                                                            <!-- <span id="hasilKerawanan" style="float: right; font-size: 12px;" class="text-danger">0/125</span> -->
                                                        </div>
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group mt-3">
                                                            <div class="text-center">
                                                                <h4><b>Fungsi & Job Desk: <b class="text-danger">*</b></b></h4>
                                                            </div>
                                                            <hr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-xl">
                    <div class="col-lg-12">
                        ...
                        <?php echo $this->session->flashdata('pesan4'); ?>
                        <form class="form-horizontal" action="<?php echo site_url('Presales/CTR_Presales/UpdateSSA2') ?>" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <?php if ($row_detail->foto_ssa2 == null) { ?>
                                                            <div class="text-center mt-2">
                                                                ...
                                                                <input type="file" id="file_ssa2" class="form-control mt-2 p-1" accept="image/png, image/jpg, image/jpeg" name="foto_ssa2[]">
                                                        ...
                                                        <?php } else { ?>
                                                            <div class="text-center mt-2">
                                                                <img src="<?php echo base_url('assets/img/ssa2/' . $row_detail->foto_ssa2) ?>" width="350px" class="img-center img-thumbnail rounded">
                                                                <p class="float-right mt-2 text-danger" style="font-size: 12px;"><b>*<i>(Maks 500KB, Format .JPG/.JPEG/.PNG)</i></b></p>
                                                                <input type="file" id="file" accept="image/png, image/jpg, image/jpeg" class="form-control mt-2 p-1 file_ssa2" name="foto_ssa2[]">
                                                                <p id="message_ssa2" class="float-right text-danger" style="font-size: 12px;"></p>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <div class="form-group-material mt-2">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <p class="float-right text-danger" style="font-size: 12px;"><b>*<i>(Maks 500KB, Format .JPG/.JPEG/.PNG)</i></b></p>
                                                            <input type="file" id="file_ssa2" name="foto_ssa2[]" accept="image/png, image/jpg, image/jpeg" class="form-control files p-1 file_ssa2">
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="form-control-label">Lokasi : <b class="text-danger">*</b></label>
                                                            <textarea cols="30" rows="5" class="form-control" required name="lokasi_kerja[]"></textarea>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <a href="<?php echo site_url('Presales/CTR_Presales/DownloadFotoSSA2/' . $row->id_detail_ssa2) ?>" class="btn btn-primary btn-sm mt-3"><i class="fas fa-download"></i> Unduh Gambar</a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    // upload Gambar
    // var uploadField1 = document.getElementsByClassName("file_ssa2");
    var txt = '';
    var ekstensiOk = /(\.jpg|\.jpeg|\.png|\.gif)$/i;
    // uploadField1.onchange = function() {
    $(".file_ssa2").on('change', function() {
