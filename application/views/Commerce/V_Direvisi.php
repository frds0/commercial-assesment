            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Direvisi</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
            <div class="mt-4">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Daftar Assesment Direvisi</h3>
                    </div>
                        ...
                        <table id="example2" class="table table1 table-bordered">
                            <thead>
                                <tr class="text-center">
                                    ...
                                    <th style="vertical-align: middle; width: 90px">Deskripsi</th>
                            ...
                            <tbody>
                                ...
                                foreach ($isi as $row) if ($row->status == "Revisi") { ?>
                                    <tr>
                                        ...
                                        <td style="vertical-align: middle;" class="text-center"><?php echo $row->deskripsi ?></td>
