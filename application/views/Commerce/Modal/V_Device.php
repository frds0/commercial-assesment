                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="form-group text-center font-weight-bold">
                                                            ...
                                                            <textarea class="form-control" rows="4" readonly name="catatan_1"><?php echo $row->catatan_1 ?></textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="form-group text-center font-weight-bold">
                                                            <p class="mb-3">Catatan Tambahan</p>
                                                            <textarea class="form-control" rows="4" readonly name="catatan_2"><?php echo $row->catatan_2 ?></textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <div class="form-group text-center font-weight-bold">
                                                            ...
                                                            <textarea class="form-control" rows="4" readonly name="catatan_3"><?php echo $row->catatan_3 ?></textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td rowspan="5">
                                                        <div class="form-group text-center font-weight-bold">
                                                            <p class="mb-3">Catatan Tambahan</p>
                                                            <textarea class="form-control" rows="16" readonly name="catatan_4"><?php echo $row->catatan_4 ?></textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <div class="form-group text-center font-weight-bold">
                                                        <p class="mb-3">Catatan</p>
                                                        <textarea class="form-control" readonly rows="4" name="catatan_5"><?php echo $row->catatan_5 ?></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <div class="form-group text-center font-weight-bold">
                                                    ...
                                                    <textarea class="form-control" rows="7" readonly name="catatan_6"><?php echo $row->catatan_6 ?></textarea>
                                                </div>
                                            </td>
                                        </tbody>
                                    </table>
                                            ...
                                            <tr>
                                                <td colspan="2">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" rows="6" readonly name="catatan_7"><?php echo $row->catatan_7 ?></textarea>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
