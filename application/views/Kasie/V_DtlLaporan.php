            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-3 mb-2">
                    ...
                    <?php if ($rowi->status == "Approved") { ?>
                        <h6><b>Approved</b> By <?php echo $rowi->nama_approval ?></h6>
                    <?php } else if ($rowi->status == "Declined") { ?>
                        <h6><b>Declined</b> By <?php echo $rowi->nama_approval ?></h6>
                    <?php } else if ($rowi->status == "Revisi") { ?>
                        <h6><b><?php echo $rowi->status ?></b> By <?php echo $rowi->nama_approval ?></h6>
                    <?php } else { ?>
                    ...
                    <div class="col-sm-3">
                        <form action="<?php echo site_url('Kasie/CTR_Kasie/UploadPpt') ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <h6>
                                    <input type="file" id="file_detail" name="file_ppt" required oninvalid="this.setCustomValidity('Pilih File Terlebih Dahulu')" oninput="setCustomValidity('')" accept=".pdf,.ppt,.pptx">
                                </h6>
                        ...
                        <div class="col-md-4">
                            <div class="small-box shadow">
                                <div class="inner bg-secondary" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                                    ...
                                    <h4 class="widget-user-desc">Form Wawancara</h4> -->
                                        ...
                                        foreach ($nama as $row) {
                                            ...
                                            <?php } else { ?>
                                                <tr>
                                                    ...
                                                    <?php if ($rowi->status == "Approved") { ?>
                                                        <td class="text-center" data-toggle="modal" data-target="#printWawancaraModal<?php echo $row->id_wawancara ?>">
                                                    ...
                                                    <?php } else { ?>
                                                        <td style="width: 50px;">
                                                            <a href="#EditWawancaraModal<?php echo $row->id_wawancara ?>" data-toggle="modal" data-target="#EditWawancaraModal<?php echo $row->id_wawancara ?>" class="btn btn-warning btn-sm">
                                        ...
                                        foreach ($isiS1 as $row) {
                                            if ($no < $length) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php } else { ?>
                                                        <td style="width: 50px;">
                                                            <a href="#EditSsa1Modal<?php echo $row->id_ssa1 ?>" data-toggle="modal" data-target="#EditSsa1Modal<?php echo $row->id_ssa1 ?>" class="btn btn-warning btn-sm">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        </td>
                                                    <?php } ?>
                        ...
                        <div class="col-md-4">
                            <div class="small-box shadow">
                                <div class="inner bg-secondary" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                                    ...
                                    <h4 class="widget-user-desc">&nbsp;</h4>
                                    <!-- <h3 class="widget-user-username">Assesment</h3>
                                    <h5 class="widget-user-desc">Form Ceklis</h5> -->
                                </div>
                                <div class="card-footer p-0 scroll">
                                    <table class="table">
                                        <?php $no = 0;
                                        ...
                                        foreach ($isiC as $row) {
                                            ...
                                            <?php } else { ?>
                                                <tr>
                                                    ...
                                                    <?php } else { ?>
                                                        <td style="width: 50px;">
                                                            <a href="#EditCeklisModal<?php echo $row->id_ceklis ?>" data-toggle="modal" data-target="#EditCeklisModal<?php echo $row->id_ceklis ?>" class="btn btn-warning btn-sm">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        </td>
                                                    <?php } ?>
                                        ...
                                        foreach ($isiS2 as $row) {
                                            ...
                                            <?php } else { ?>
                                                <tr>
                                                    ...
                                                    <?php } else { ?>
                                                        <td style="width: 50px;">
                                                            <a href="#EditSsa2Modal<?php echo $row->id_ssa2 ?>" data-toggle="modal" data-target="#EditSsa2Modal<?php echo $row->id_ssa2 ?>" class="btn btn-warning btn-sm">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        </td>
                                                    <?php } ?>
                        ...
                        <div class="col-md-4">
                            <div class="small-box shadow">
                                <div class="inner bg-secondary" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                                    ...
                                    <h4 class="widget-user-desc">&nbsp;</h4>
                                    <!-- <h3 class="widget-user-username">Assesment</h3>
                                    <h5 class="widget-user-desc">Form Survey Device</h5> -->
                                </div>
                                <div class="card-footer p-0 scroll">
                                    <table class="table">
                                        <?php $no = 0;
                                        ...
                                        foreach ($isiD as $row) {
                                            ...
                                            <?php } else { ?>
                                                <tr>
                                                    ...
                                                    <?php } else { ?>
                                                        <td style="width: 50px;">
                                                            <a href="#EditDeviceModal<?php echo $row->id_device ?>" data-toggle="modal" data-target="#EditDeviceModal<?php echo $row->id_device ?>" class="btn btn-warning btn-sm">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        </td>
                                                    <?php } ?>
                                        ...
                                        foreach ($isiCt as $row) {
                                            ...
                                            <?php } else { ?>
                                                <tr>
                                                    ...
                                                    <?php } else { ?>
                                                        <td style="width: 50px;">
                                                            <a href="#EditCctvModal<?php echo $row->id_cctv ?>" data-toggle="modal" data-target="#EditCctvModal<?php echo $row->id_cctv ?>" class="btn btn-warning btn-sm">
                                                                <i class="fas fa-edit"></i>
                                                            </a>
                                                        </td>
                                                    <?php } ?>
...
<script type="text/javascript">
    // upload Gambar
    var uploadField = document.getElementById("file_detail");
    var txt = '';
