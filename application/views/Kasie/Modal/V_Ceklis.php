                ...
                <div class="modal-body modal-xl">
                    <div class="col-lg-12">
                        ...
                        <div class="card" style="overflow: auto;">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('Kasie/CTR_Kasie/SimpanCeklis/') ?>" enctype="multipart/form-data" method="POST">
                                <div class="card-body">
                ...
                <div class="modal-body modal-xl">
                    <div class="col-lg-12">
                        <div class="card" style="overflow: auto;">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('Kasie/CTR_Kasie/UpdateCeklis/') ?>" enctype="multipart/form-data" method="POST">
                                <div class="card-body">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="<?php echo site_url('CTR_Laporan/PrintCeklis/' . $row->id_permintaan) ?>" method="POST">
                                ...
                                <div class="text-right">
                                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal"><i class="fas fa-window-close"></i> Batal</button>
