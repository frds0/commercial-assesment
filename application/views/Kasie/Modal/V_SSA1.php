                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form class="form-horizontal" action="<?php echo site_url('Kasie/CTR_Kasie/SimpanSSA1') ?>" method="POST">
                                    <div class="row">
                                        <div class="col-lg-6">
                ...
                <div class="modal-body modal-xl">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('Kasie/CTR_Kasie/UpdateSSA1') ?>" method="POST" name='forminput1'>
                                <div class="card-body">
                                    <center>
                                        <h5><b>A. Background Perusahaan</b></h5>
                                    </center>
