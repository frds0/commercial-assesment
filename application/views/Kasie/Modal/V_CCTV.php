                                ...
                                if ($row_detail->id_cctv == $row->id_cctv) { ?>
                                    <div class="card mt-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form class="form-horizontal" method="POST" action="<?php echo site_url('Kasie/CTR_Kasie/SimpanCCTV') ?>" enctype="multipart/form-data">
                                                <div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body modal-xl">
                    <div class="col-lg-12">
                        ...
                        <form class="form-horizontal" method="POST" action="<?php echo site_url('Kasie/CTR_Kasie/UpdateCCTV') ?>" enctype="multipart/form-data">
                            <?php $no = 1;
                            foreach ($isi_detail_Ct as $row_detail) {
                                if ($row_detail->id_cctv == $row->id_cctv) { ?>
                                    <div class="card">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <div class="form-group-material mt-4">
                                                            ...
                                                            <input type="file" id="file_belakang" name="view_belakang[]" accept="image/png, image/jpg, image/jpeg" size="20" class="mb-4 p-1 form-control">
                                                            <p id="message_file1" class="float-right text-danger" style="font-size: 12px;"></p>
                                                            <div class="text-center">
                                                                <img src="<?php echo base_url('assets/img/cctv/belakang/' . $row_detail->view_belakang) ?>" width="350px" style="height: 350px;" class="img-thumbnail rounded file_cctv_belakang">
                            ...
                            <?php if ($this->input->post('jumlah_cctv')) { ?>
                                <?php
                                echo form_open_multipart('Kasie/CTR_Kasie/SimpanCCTV') ?>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <a download="<?php echo base_url('assets/img/cctv/depan/' .  $row->view_depan) ?>" href="<?php echo base_url('assets/img/cctv/depan/' .  $row->view_depan) ?>" class="btn btn-primary btn-sm mt-3"><i class="fas fa-download"></i> Unduh Gambar</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <a download="<?php echo base_url('assets/img/cctv/belakang/' .  $row->view_belakang) ?>" href="<?php echo base_url('assets/img/cctv/belakang/' .  $row->view_belakang) ?>" class="btn btn-primary btn-sm mt-3"><i class="fas fa-download"></i> Unduh Gambar</a>
                </div>
            </div>
        </div>
    </div>
